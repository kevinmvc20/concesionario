    ...
    <div class="row">
        <div class="col-lg-3 col-sm-2 col-md-2 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="empleado_id" id="empleado_id" class="form-control " value="{{ auth()->user()->persona->nombre }}" disabled>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="panel panel-primary">
            <div class="panel-body">
                ...
                <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                    <div class="form-group">
                        <button type="button" id="agregar" class="btn btn-primary" style="margin-top: 20px">Agregar Orden Compra</button>
                    </div>
                </div>
    ...
    <script>
        ...
        function agregar(){
            ...
            if ( vehiculo_id != "" &&  precio_unitario !="" && precio_unitario >= 0 ) {
                ...
                div.textContent = 'Error al ingresar los datos';
